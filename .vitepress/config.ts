...
export default defineConfig({
  ...
  themeConfig: {
    ...
    sidebar: [
      {
        items: [
          { text: '介绍', link: '/guide/' },
          {
            text: '单字输入', link: '/guide/zi/', collapsed: false, items: [
          ...
          {
            text: '符号输入', link: '/guide/symbols/', collapsed: false, items: [
              { text: 'V 键', link: '/guide/symbols/v' },
              { text: 'E 键', link: '/guide/symbols/e' },
            ]
          },
          {
            text: '命令直通车', link: '/guide/commands/', collapsed: true, items: [
    ...
    </svg>`}, link: 'https://jq.qq.com/?_wv=1027&k=lcIrfCWn'
      },
    ],
